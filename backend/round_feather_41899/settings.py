"""
Django settings for round_feather_41899 project.
...
ROOT_URLCONF = 'round_feather_41899.urls'
...
WSGI_APPLICATION = 'round_feather_41899.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_feather_41899 API",
    "DESCRIPTION": "API documentation for round_feather_41899 App",
    "VERSION": "v1",
}
